...
# **18 -> 19 at the merge, and the OBJECT grew rather than the defect.** The nineteenth is
# `messung/proben/probe-stellungen.gab`, written the same day, and it falls into the same
