...
lauf "beispiel26" "$W/beispiele/26-gleitkomma.gab" "$TREIBER26" "0.2 0.5 0.5 0.8 1.0" \
     ...
     "2 assumptions (0 of them NOT FALSIFIABLE, 0 UNCOVERED -- named a probe that does not exist as a program), 0 templates (0 of them UNPROVED), 6 direct forms, 0 foreign bodies (0 state their duty), 0 narrowings from foreign contracts"
...
# **89 -> 91 on 2026-09-13 (lane 137, measured on the merged tree).** `+2`
# are `108-disjoint-start-locks` and `109-lockfree-entry-roots` (this lane:
...
# **8 -> 12 on 2026-09-13 (lane 138, measured).** `+4` are 930 (then 915), 916, 918, 919:
...
# **12 -> 16 on 2026-09-14 (lane 191, measured).** `+4` are 04, 580, 700, 701:
...
MARKE_EMIT_G=16     # 286, 414, 689, 718, 719, 727, 758, 777 + 916, 918, 919, 930 + 04, 580, 700, 701 -- measured, see above
#
