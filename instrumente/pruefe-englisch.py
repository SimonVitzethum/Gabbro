...
# a row here.*
# **7910 -> 7906 -> 7900 on 2026-08-31.** Six more fell with the floating-point notice: it is
# written INTO the generated C, so it reaches a reader who never opens this tree, and the rest
# of that C is English. *A notice about `-ffast-math` in the wrong language is the one piece of
# prose here that has an outside audience.* Four lines fell where a German comment was rewritten in
...
# one above the measurement, and nobody had pulled it down. *A ratchet that is only ever
