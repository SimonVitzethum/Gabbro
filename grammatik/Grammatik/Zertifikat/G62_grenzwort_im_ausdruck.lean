-- GENERATED by `gabbro obligations --g beispiele/62-grenzwort-im-ausdruck.gab` (lean-g export plus the stated obligation) -- do not edit.
...
-- fn ist_kleinster (holds; writes)
-- fn zwei_wege_eine_maske (holds; writes)
...
namespace G62_grenzwort_im_ausdruck_oblig
...
def gSig_invertiere : Signatur GTab Empty GLock Empty where
  params := [(.int 0 4294967295)]
...
def gSig_passt_in_16 : Signatur GTab Empty GLock Empty where
  params := [(.int 0 4294967295)]
  erg := some (.bool)
  gruende := 0
  haelt := []
...
def gSig_ist_kleinster : Signatur GTab Empty GLock Empty where
  params := [(.int (-2147483648) 2147483647)]
  erg := some (.bool)
  gruende := 0
  haelt := []
  boden := none
...
def gSig_zwei_wege_eine_maske : Signatur GTab Empty GLock Empty where
  params := [(.int 0 255)]
  erg := some (.bool)
  gruende := 0
  haelt := []
...
abbrev gD : Deklaration where
  ...
  eigner := fun _ => []
  Fn := GFn
  sig := fun | .invertiere => 0 | .passt_in_16 => 1 | .ist_kleinster => 2 | .zwei_wege_eine_maske => 3
  sigNr := fun | 0 => gSig_invertiere | 1 => gSig_passt_in_16 | 2 => gSig_ist_kleinster | 3 => gSig_zwei_wege_eine_maske | _ => gSig_zwei_wege_eine_maske
...
abbrev gCtx_invertiere : Ctx := [(.int 0 4294967295)]
def g_invertiere : gD.Fn := GFn.invertiere
abbrev gCtx_passt_in_16 : Ctx := [(.int 0 4294967295)]
def g_passt_in_16 : gD.Fn := GFn.passt_in_16
abbrev gCtx_ist_kleinster : Ctx := [(.int (-2147483648) 2147483647)]
def g_ist_kleinster : gD.Fn := GFn.ist_kleinster
abbrev gCtx_zwei_wege_eine_maske : Ctx := [(.int 0 255)]
def g_zwei_wege_eine_maske : gD.Fn := GFn.zwei_wege_eine_maske

abbrev gL_invertiere : List (Res gD) := []
abbrev gL_passt_in_16 : List (Res gD) := []
abbrev gL_ist_kleinster : List (Res gD) := []
abbrev gL_zwei_wege_eine_maske : List (Res gD) := []


def gBody_invertiere : Endblock gD (vertragVon gD g_invertiere) false gCtx_invertiere gL_invertiere :=
  (.ret (.wert (.bxor 32 (by decide) (by decide) (by decide) (by decide) (.var .hier) (((.lit 4294967295)) : Expr gD gCtx_invertiere gL_invertiere (.int 4294967295 4294967295)))) (List.Perm.refl _))

def gBody_passt_in_16 : Endblock gD (vertragVon gD g_passt_in_16) false gCtx_passt_in_16 gL_passt_in_16 :=
  (.ret (.wert (.le (.var .hier) (((.lit 65535)) : Expr gD gCtx_passt_in_16 gL_passt_in_16 (.int 65535 65535)))) (List.Perm.refl _))

def gBody_ist_kleinster : Endblock gD (vertragVon gD g_ist_kleinster) false gCtx_ist_kleinster gL_ist_kleinster :=
  (.ret (.wert (.eq (.var .hier) (((.lit (-2147483648))) : Expr gD gCtx_ist_kleinster gL_ist_kleinster (.int (-2147483648) (-2147483648))))) (List.Perm.refl _))

def gBody_zwei_wege_eine_maske : Endblock gD (vertragVon gD g_zwei_wege_eine_maske) false gCtx_zwei_wege_eine_maske gL_zwei_wege_eine_maske :=
  (.ret (.wert (.eq (.bxor 8 (by decide) (by decide) (by decide) (by decide) (.var .hier) (((.lit 255)) : Expr gD gCtx_zwei_wege_eine_maske gL_zwei_wege_eine_maske (.int 255 255))) (.bxor 8 (by decide) (by decide) (by decide) (by decide) (.var .hier) (((.lit 255)) : Expr gD gCtx_zwei_wege_eine_maske gL_zwei_wege_eine_maske (.int 255 255))))) (List.Perm.refl _))
...
def gP : Programm gD where
  ...
  ensures
    ...
    | .zwei_wege_eine_maske => .wahr
  rumpf
    | .invertiere => gBody_invertiere
    | .passt_in_16 => gBody_passt_in_16
    | .ist_kleinster => gBody_ist_kleinster
    | .zwei_wege_eine_maske => gBody_zwei_wege_eine_maske

def gFs : List gD.Fn := [g_invertiere, g_passt_in_16, g_ist_kleinster, g_zwei_wege_eine_maske]
...
end G62_grenzwort_im_ausdruck_oblig
