-- GENERATED by `gabbro obligations --g beispiele/69-integer-conversion.gab` (lean-g export plus the stated obligation) -- do not edit.
...
namespace G69_integer_conversion_oblig
...
def gSig_kombiniert : Signatur GTab Empty GLock Empty where
  params := [(.int 0 4294967295), (.int 0 4294967295)]
...
abbrev gD : Deklaration where
  ...
  eigner := fun _ => []
  Fn := GFn
  sig := fun | .kombiniert => 0
  sigNr := fun | 0 => gSig_kombiniert | _ => gSig_kombiniert
...
abbrev gCtx_kombiniert : Ctx := [(.int 0 4294967295), (.int 0 4294967295)]
def g_kombiniert : gD.Fn := GFn.kombiniert

abbrev gL_kombiniert : List (Res gD) := []


def gBody_kombiniert : Endblock gD (vertragVon gD g_kombiniert) false gCtx_kombiniert gL_kombiniert :=
  (.ret (.wert (.bor 64 (by decide) (by decide) (by decide) (by decide) ((.weiter (by decide) (by decide) (.var .hier)) : Expr gD gCtx_kombiniert gL_kombiniert (.int 0 18446744073709551615)) ((.weiter (by decide) (by decide) (.var (.dort .hier))) : Expr gD gCtx_kombiniert gL_kombiniert (.int 0 18446744073709551615)))) (List.Perm.refl _))
...
def gP : Programm gD where
  ...
  ensures
    | .kombiniert => .wahr
  rumpf
    | .kombiniert => gBody_kombiniert

def gFs : List gD.Fn := [g_kombiniert]
...
end G69_integer_conversion_oblig
