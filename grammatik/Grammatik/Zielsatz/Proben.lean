...
theorem ungeschuetzt_abgelehnt_gilt : ungeschuetzt_abgelehnt := by
  ...
  · rcases Bool.or_eq_true_iff.mp h with h | h
    ...
    · unfold lokW at h
      ...
      have := hg w₁ h₁ w₂ h₂ (Or.inl hne) w₁ w₂ (reachB_wurzel P fs w₁) (fuss_teilG P w₁ hc)
...
theorem zweiFaeden_bewegt_gilt : zweiFaeden_bewegt := by
  ...
  refine ⟨speicherR mSp, _, 0, M1, laufzeit_initRuhe mE, .schritt _ _ _ .start s1, ?_⟩
  intro h
