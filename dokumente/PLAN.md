...
```
H = 3        ueber den zehn Fragmenten kein Handbeweis mehr  (abgelesen, s. u.)
...
| **Absenkungspflichten** | **3** | `zaehle-pflichten.py --haengend` | in `H` enthalten, nicht in den Fragmenten |
