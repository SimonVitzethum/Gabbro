...
>
> **Heute steht dort 45** *(2026-09-02, `cargo run -q --bin gabbro -- annahmen beispiele/*.gab`;
...
```
H = 2        über dem Fragmentkorpus, mit ./instrumente/zaehle-pflichten.py neu abgeleitet
