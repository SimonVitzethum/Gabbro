...
| **K** — Klempnerei | **Bleibt nach der Absenkung eine Pflicht am Menschen, die nicht seine eigene Logik ist?** Heute ~~`H = 5`~~ ~~`H = 4`~~ ~~`H = 3`~~ ~~`H = 2`~~ **`H = 1`** *(F6 durchgestochen 2026-08-31, F9, F1 und F5 am 2026-09-03)* |
...
~~`H = 5`~~ ~~`H = 4`~~ ~~`H = 3`~~ ~~`H = 2`~~ **`H = 1`** — *das erzeugte C rechnet, was
das Fragment sagt*, offen nur noch für **F3**. Für **F1**, F2, F4, **F5**, **F6**, F7, F8,
**F9**, F10 ist sie **durch Ausführung** eingelöst: erzeugt, übersetzt, ausgeführt, gegen
eine Handschrift verglichen.
