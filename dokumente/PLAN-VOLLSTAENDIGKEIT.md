...
| **K** — Klempnerei | **Bleibt nach der Absenkung eine Pflicht am Menschen, die nicht seine eigene Logik ist?** Heute ~~`H = 5`~~ ~~`H = 4`~~ ~~`H = 3`~~ **`H = 2`** *(F6 durchgestochen 2026-08-31, F9 und F1 am 2026-09-03)* |
...
~~`H = 5`~~ ~~`H = 4`~~ ~~`H = 3`~~ **`H = 2`**, und beide sind **dieselbe** Pflicht: *das
erzeugte C rechnet, was das Fragment sagt* — offen für F3 und F5. Für **F1**, F2, F4, **F6**,
F7, F8, **F9**, F10 ist sie **durch Ausführung** eingelöst: erzeugt, übersetzt, ausgeführt,
gegen eine Handschrift verglichen.
