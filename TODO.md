...
- [ ] **~~54 or 102 relational preconditions?~~ — aufgelöst 2026-08-20, und es war kein
      ...
      *__ZUM ACHTEN MAL, AM SELBEN TAG WIE DAS SIEBTE, UND DIE HALBHEIT IST WIEDER EINE
      ...
      war `master` ueber `c7cbe07` gelaufen und hatte `messung/BERICHT-O3-RATSCHE.md`
      mitgebracht, also stand er selbst schon auf 196. **Die gemessene Wahrheit nach dem
      Merge ist 197.** Ursache gemessen wie der Eintrag es verlangt: eigene Datei
      weggenommen, `pruefe-widerruf.py` sagt 196, Datei zurueck, 197. *Diesmal war die
      Zahl der Bahn nicht veraltet, sondern MEHRDEUTIG: dieselbe 196 stand fuer zwei
      verschiedene Dateimengen.* **Zwei gleiche Ziffern ueber verschiedenen Mengen sind
      genau das, was `git` nicht sehen kann** -- und `pruefe-zahlen.py` hat es gesehen,
      weil es den Befehl nachrechnet statt den Text zu vergleichen.*
      ...
      *178 → 179 on 2026-09-02: `messung/LEAN-REICHWEITE.md` joined — how far the Lean channel
      ...
      and `abnahme.py` is the tool that does not have this hole.*      *176 → 177 on 2026-09-02: `messung/BERICHT-UEBERSETZERFAMILIE.md` joined — the report on
      ...
      *163 → 165 am 2026-09-01: `messung/PROBENZWEIGE.md` und `instrumente/zaehle-probenzweige.py`
      ...
      ein Wächter, der sich selbst ausnimmt, misst die Hälfte.*
      ...
      **Jede Bahn schrieb eine andere Zahl, und beide hatten recht über ihrem Baum** — die
      einzige, die stimmt, kommt aus dem Wächter.*
      *149 → 151 am 2026-08-31, aus ZWEI Bahnen gleichzeitig: `messung/proben/PLAN-ENGLISCH.md`
      ...
      Zahlen, und die einzige, die stimmt, kommt aus dem Wächter selbst.*
      *148 → 149 am 2026-08-31: `messung/DOMAENENSTELLUNGEN.md` kam dazu.*
      *149 → 150 am 2026-08-31: `messung/proben/PLAN-ENGLISCH.md` kam dazu — der
      Gegenstand ist gewachsen, nicht die Nachsicht.*
...
- [ ] **`guarded` und `covered` sind VERSCHIEDENE Stärken, und die Trennung wird verlockend
      ...
      **Seit dem 2026-08-20 stehen beide Zahlen im Register und nicht mehr nur im Bericht:**
      ~~169~~ ~~170~~ ~~25~~ ~~171~~ ~~172~~ **174 besetzte Zellen** stehen daneben, **25 nur im Gift** (2026-09-14, lane 170: `traverse in traverse` turns covered -- `beispiele/122` nests two `elems of` loops; 2026-09-13, lane 152: `atomic × written` and `tagged × return (body)` turn poison-only, `atomic × read` turns covered; 2026-09-14, lane 184: `table × return (ptr, proto)` turns poison-only -- `gift/968` returns a table pointer from an `extern fn`; covered 172→174 holds merged-wave drift plus this one cell, poison-only stays 25) — und `gabbro blindstellen`
...
- [ ] ~~105~~ ~~108~~ ~~117~~ **158 Absagetexte sagen ihren Grund in KEINER der beiden Sprachen** (`./instrumente/pruefe-gruende.py`,      2026-08-20). Die billige Näherung sortiert jede Regel danach, ob ihre Begründung eine
      ...
      Pfad"*) nennt. ~~129~~ ~~130~~ ~~131~~ ~~132~~ ~~139~~ ~~143~~ ~~177~~ 173 sind tragend, 8 verdächtig (2026-09-14, lane 191 gemessen: 172 auf HEAD, +1 `N305` mit tragendem Grund) — und **~~87~~ ~~107~~ ~~117~~ **158** Absagetexte sagen ihren Grund in
      ...
      *7 → 8 verdächtig, 107 → 117 unklar am 2026-09-12 (lane S6): `C184` steht in der
      verdächtigen Spalte (sein Text nennt die Übersetzung, nicht die Zusage — `number`/`bound`
...
Konstrukt — und **die Fehler sitzen an den Kombinationen**: ~~79~~ ~~78~~ ~~73~~ 73 blinde Zellen von 285. (2026-09-14, lane 191 gemessen: 74 auf HEAD, 73 mit den drei eigenen Dateien `130`/`131`/`968`; eine Zelle füllt diese Bahn: `table × return (ptr, proto)` — covered 174, poison-only 25). Jedes echte
...
**144 fremde Rümpfe im Korpus, 11 sprechen ihre Pflicht aus (2026-09-14, lane 184 gemessen: +22 Drift der zusammengeführten Bahnen — diese Bahn fügt keine Rümpfe hinzu: `130`/`131` sind rein, Gifts zählen nicht) — und genau EINE verengt wirklich
...
```
~~7881~~ ~~7883~~ ~~7891~~ ~~7892~~ **7938 von 36122 Kommentarzeilen** im Pruefer sind deutsch (2026-09-14, lane 191 gemessen: 184 noch 7938/35949, hier 7938/36122 — +173 Zeilen, davon keine einzige deutsch)
...
- [ ] **Was eine Doppelvergabe RÜCKWIRKEND kostet, und das ist teurer als der Fund**
      *(gemessen 2026-08-21)*. Die Giftproben prüfen auf **Kennungen**. Eine doppelt
      ...
      ```
      ~~68~~ ~~70~~ ~~71~~ ~~73~~ ~~84~~ ~~88~~ 93 Proben zeigen auf eine Kennung mit unaehnlichen Vergabestellen (von 654
      Giftproben) (2026-09-14, lane 191 gemessen: 93 auf HEAD wie mit dieser Bahn)
      ```
