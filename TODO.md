...
- [ ] **~~54 or 102 relational preconditions?~~ — aufgelöst 2026-08-20, und es war kein
      ...
      *~~103~~ … ~~115~~ ~~117~~ — am 2026-08-30 **achtmal** nachgezogen, aus sechs Ketten, und
      jedes Mal, weil ein Bericht geschrieben wurde. **Die Zahl misst den Ordner, nicht die
      Arbeit**, und sie ist an genau einem Tag von 103 auf 118 gestiegen, ohne dass ein
      einziger Widerruf dazukam: die Reichweite wächst mit jedem Dokument unter `messung/`,
      die Zahl der Widerrufe steht seit Wochen bei zwölf. Die 118. ist
      `messung/AUFLOESUNG-BEZUGSGROESSE.md`.*
