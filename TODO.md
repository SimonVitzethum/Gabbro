...
- [ ] **~~54 or 102 relational preconditions?~~ — aufgelöst 2026-08-20, und es war kein
      ...
      *156 → 157 am 2026-09-01: `dokumente/PLAN-HARDWARE.md` kam dazu — der Gegenstand
      wächst, nicht die Nachsicht.*
...
- [ ] **89 Absagetexte sagen ihren Grund in KEINER der beiden Sprachen** (`./instrumente/pruefe-gruende.py`,
      ...
      Pfad"*) nennt. 113 sind tragend, 3 verdächtig — und **87 Absagetexte sagen ihren Grund in
...
**97 fremde Rümpfe im Korpus, 11 sprechen ihre Pflicht aus — und genau EINE verengt wirklich
...
sofort: *kein neuer Absagecode ohne seinen Satz* (2026-08-21 gebaut; heute 81 Sätze über 253 Codes, 45 Codes noch ohne — `D017`/`D018` kamen am 2026-08-31 mit ihrem Satz `d.domaenenort` im selben Commit).
