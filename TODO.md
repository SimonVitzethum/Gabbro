...
- [ ] **~~Die 161 zerbrochenen Meldungen hat kein Waechter gesehen~~ — GEBAUT 2026-08-20.**
      ...
      *und die Einrückung*, also hängt die Trennung an genau einem Zeichen — dem letzten davor.
      Heute **2865 Zeilenfortsetzungen** in den Quellen, **0 kleben**, **0 geplatzt**.      *Am 2026-08-31 fiel die Zahl erst von 2102 auf 2101* — eine übersetzte Parsermeldung
...
sofort: *kein neuer Absagecode ohne seinen Satz* (2026-08-21 gebaut; heute 87 Sätze über 267 Codes, 50 Codes noch ohne — `D017`/`D018` kamen am 2026-08-31 mit ihrem Satz `d.domaenenort` im selben Commit).
