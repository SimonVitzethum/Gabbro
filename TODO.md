...
- [ ] **50 Absagetexte sagen ihren Grund in KEINER der beiden Sprachen** (`./instrumente/pruefe-gruende.py`,
      ...
      Pfad"*) nennt. 118 sind tragend, 2 verdächtig — und **49 Absagetexte sagen ihren Grund in
...
- [ ] **~~Die 161 zerbrochenen Meldungen hat kein Waechter gesehen~~ — GEBAUT 2026-08-20.**
      ...
      *und die Einrückung*, also hängt die Trennung an genau einem Zeichen — dem letzten davor.
      Heute **1613 Zeilenfortsetzungen** in den Quellen, **0 kleben**.
...
- [ ] **The mutation probe covers the checker today, not the emission.**
      ...
      fällt. Mutationskatalog: **292 von 292 Ankern** greifen (`--anker`, 2026-08-24) — die
