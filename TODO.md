...
- [ ] **~~54 or 102 relational preconditions?~~ — aufgelöst 2026-08-20, und es war kein
      ...
      **Berichtigt.** *Was offen bleibt, ist die allgemeine Form dieses Falls:* zwei Zahlen aus
      ...
      heute **12 Widerrufe** über 147 Dateien, und keiner davon ist eine Teilmengenbeziehung.
...
- [ ] **87 Absagetexte sagen ihren Grund in KEINER der beiden Sprachen** (`./instrumente/pruefe-gruende.py`,
      ...
      Pfad"*) nennt. 105 sind tragend, 3 verdächtig — und **87 Absagetexte sagen ihren Grund in
      ...
      *104 → 105 tragende am selben Tag: `N043` nennt die Absenkungseigenschaft in seinem
...
- [ ] **~~Die 161 zerbrochenen Meldungen hat kein Waechter gesehen~~ — GEBAUT 2026-08-20.**
      ...
      *und die Einrückung*, also hängt die Trennung an genau einem Zeichen — dem letzten davor.
      Heute **2308 Zeilenfortsetzungen** in den Quellen, **0 kleben**.
...
sofort: *kein neuer Absagecode ohne seinen Satz* (2026-08-21 gebaut; heute 75 Sätze über 243 Codes, 45 Codes noch ohne).
