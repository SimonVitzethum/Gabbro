...
- [ ] **The mutation probe covers the checker today, not the emission.**
      ...
      fällt. Mutationskatalog: **344 von 344 Ankern** greifen (`--anker`, 2026-08-30) — die
      acht des Rumpfkanals kamen am 28. abends dazu, und am 30. vier weitere: der **vierte
      Ort der Geistlöschung** (ein `let`-gebundener Geist, blank genannt) und die drei
      Hälften von `return e;` am fehlbaren Register — Bindung (`M1`), Anerkennung (`N034`)
      und der Kanal, durch den der Grund hinausgeht (`emit.rs`). Drei bewachen den
