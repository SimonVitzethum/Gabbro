...
- [ ] **~~54 or 102 relational preconditions?~~ — aufgelöst 2026-08-20, und es war kein
      ...
      **Berichtigt.** *Was offen bleibt, ist die allgemeine Form dieses Falls:* zwei Zahlen aus
      ...
      heute **13 Widerrufe** über 381 Dateien, und keiner davon ist eine Teilmengenbeziehung.
...
<      Pfad"*) nennt. ~~129~~ ~~130~~ ~~131~~ ~~132~~ ~~139~~ 140 sind tragend, 7 verdächtig — und **~~87~~ 107 Absagetexte sagen ihren Grund in
...
- [ ] **The parser is laxer than the EBNF at THREE places** *(was: six; corrected and
      ...
      **Und die Messschicht sagt, warum die drei stehenbleiben:** `./instrumente/pruefe-syntax.sh` hält
      167 EBNF-Regeln und 226 Terminale gegen die Wortschatztabelle — *er misst die Grammatik
...
- [ ] **THE DECISION that P2 forces: the closed vocabulary collides with
      ...
      *Kein Messposten: die Zahlen (neun Wörter, elf Stellen) stehen, und `pruefe-wortschatz.py`
      hält 226 Terminale gegen die Tabelle. **Was fehlt, ist ein Urteil**, und der Preis steht
...
~~117~~ **120 fremde Rümpfe im Korpus, 11 sprechen ihre Pflicht aus** — und genau EINE verengt wirklich
...
- [ ] **Was eine Doppelvergabe RÜCKWIRKEND kostet, und das ist teurer als der Fund**
      *(gemessen 2026-08-21)*. Die Giftproben prüfen auf **Kennungen**. Eine doppelt
      ...
      ```
      ~~68~~ ~~70~~ ~~71~~ ~~73~~ 77 Proben zeigen auf eine Kennung mit unaehnlichen Vergabestellen (von 546
      Giftproben)
      ```
...
<sofort: *kein neuer Absagecode ohne seinen Satz* (2026-08-21 gebaut; heute 120 Sätze über 306 Codes, 55 Codes noch ohne — `D017`/`D018` kamen am 2026-08-31 mit ihrem Satz `d.domaenenort` im selben Commit).**Und der zweite Zahn hat am 2026-08-31 gegriffen:** `N042` kam mit seinem Satz im selben Commit— 241 → 242 Codes, 73 → 74 Sätze, und die 45 blieben stehen. *285 → 289 Codes, 101 → 105 Sätze, 51 → 53 ohne am 2026-09-09:* `D025`/`D026`/`K011`/`K012` kamen mit ihren Sätzen im selben Commit. *Genau die Bewegung, für die der
Zahn gebaut wurde: die Ratsche steigt am Gegenstand und nicht an der Schuld.* (2026-09-12, lane E1: +1 Satz mit seinem Code, `namen.library_call` über `N057`. 2026-09-12, lane-89-Merge: heute 120 Sätze über 306 Codes, 55 ohne — nachgemessen im zusammengeführten Baum.)
...
| **5** | **Stale numbers from P1**: 117 rules, 187 terminals (today 167 / 226) | taken out along with the entry |
