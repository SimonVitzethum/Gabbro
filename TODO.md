...
- [ ] **103 Absagetexte sagen ihren Grund in KEINER der beiden Sprachen** (`./instrumente/pruefe-gruende.py`,      2026-08-20). Die billige Näherung sortiert jede Regel danach, ob ihre Begründung eine
      ...
      Pfad"*) nennt. ~~124~~ 125 sind tragend, 7 verdächtig — und **87 Absagetexte sagen ihren Grund in
