...
`crates/gabbro-check/src/m1.rs` only, pinned by gift probes 764/765/766 and
...
`crates/gabbro-check/src/m1.rs` only, pinned by gift probe 767 and two unit
...
- `a : i32 in 0 .. 100`, `b : i32 in 0 .. 50` under `a >= b` into `i64`:
  ...
  `enge_v2_differenz_schweigt`, gift 767 second arm).
- Gift 767 first arm and unit test `offene_v2_differenz_faellt_an_der_operation`
