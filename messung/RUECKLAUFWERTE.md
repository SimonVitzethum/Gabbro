...
* ~~**Der leere Baum ist die billigste Absage, nicht die einzige.** Ein Wächter, dessen
  ...
  *`61 von 66`/`376` → `65 von 71`/`409` am 2026-09-15, nachgemessen in beiden Bäumen:* der
  Stand **vor** dieser Bahn war schon `64`/`404` — drei Wächter und 28 Ausgangsstellen aus
  Bahnen davor standen unbebucht da, und `pruefe-zahlen.py` war deswegen an dieser Zeile rot.
