...
**Open (plan §6.5, SATZKARTE §26):** `korrOk` lacks `if`, `traverse`, compound assignment,
...
**Both stage (a) and stage (b) add a SATZKARTE §26** -- renumber one of them to §27 at merge.
