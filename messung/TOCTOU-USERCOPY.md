...
(user-copy functions only), `beispiele/gift/766-768`, this note. The V-clock/pairing
...
|---|---|---|
| `beispiele/gift/766-checked-user-pointer-handed-to-copy.gab` | comparison check, then handoff to copying callee | exactly one `V012`, 0 hints |
| `beispiele/gift/767-narrowed-user-pointer-handed-to-copy.gab` | `narrow` check, then handoff | exactly one `V012`, 0 hints |
| `beispiele/gift/768-checked-user-pointer-forwarded-twice.gab` | two-hop forward, use at the far end | exactly one `V012` at the FIRST hop; second hop silent (no check beside it) |
...
cargo run -q -p gabbro-cli -- pruefe beispiele/gift/766-checked-user-pointer-handed-to-copy.gab
cargo run -q -p gabbro-cli -- pruefe beispiele/gift/767-narrowed-user-pointer-handed-to-copy.gab
cargo run -q -p gabbro-cli -- pruefe beispiele/gift/768-checked-user-pointer-forwarded-twice.gab
```
