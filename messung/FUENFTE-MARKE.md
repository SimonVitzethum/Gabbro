...
| write while armed | `beispiele/gift/671-writing-while-the-device-owns-it.gab` | `8 items, 1 errors` — `[N030] b1 is a GeraetPuffer, and schreibe takes a FahrerPuffer there` |
| reclaim without arm | `beispiele/gift/672-reclaiming-a-buffer-that-was-never-armed.gab` | `7 items, 1 errors` — `[N030] b is a FahrerPuffer, and hole_unbelegt takes a GeraetPuffer there` |
| receipt from thin air | `beispiele/gift/673-a-receipt-made-out-of-thin-air.gab` | `6 items, 1 errors` — `[D004] the return value silently converts gift::beleg_transport::Beleg` |
