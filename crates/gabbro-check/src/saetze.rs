...
pub const PHASEN: &[Satz] = &[
    ...
    Satz {
        ...
        vorbehalt: "Checker rules with no model: `Akzeptiert`/`Ziel` know no \
                    statement-level start, and the exporter refuses the statement \
                    too (`LG004`, the model lane's). The emitter lowers it since \
