...
assembly** — **65 clean examples, of which 52 emit C, and every emitted unit compiles** under `cc -std=c11 -Wall
...
./instrumente/mutiere-pruefer.py                                 # damage one rule at a time: 385 mutations, one anchor each (`--anker`)
