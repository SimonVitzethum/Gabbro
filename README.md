...
| | | |
|---|---|---|
| **Compiler** | 12 passes, 3 complete, 9 partial, **0 open** | 151 diagnostics · `gabbro paesse` |
...
| **Corpus** | 32 clean examples, 146 poison files, 127 tests *(run 2026-08-19)* | `cargo test` |
