...
| | | |
|---|---|---|
| **Compiler** | 12 passes, 3 complete, 9 partial, **0 open** | 162 diagnostics · `gabbro paesse` |
...
| **Corpus** | 33 clean examples, 158 poison files, 127 tests *(run 2026-08-19)* | `cargo test` |
