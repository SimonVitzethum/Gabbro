...
| **Guardians** | 17, and **23 of 23 instruments carry all three requirements** (deadline · two-way speech test · red on abort), held by `./pruefe-waechter.py`. *The static half reads SOURCE; `--lauf` runs the light ones under a deadline* | **234 of 234 mutations caught** *(run 2026-08-20)* |
