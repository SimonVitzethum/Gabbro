...
| | | |
|---|---|---|
| **Compiler** | 12 passes, 3 complete, **9 carried with a named residue**, 0 partial, 0 open | 172 diagnostics · `gabbro paesse` |
...
| **Corpus** | 36 clean examples, 176 poison files, 146 tests *(run 2026-08-20)* | `cargo test` |
