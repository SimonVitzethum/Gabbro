...
| | | |
|---|---|---|
| **Compiler** | 12 passes, 3 complete, **9 carried with a named residue**, 0 partial, 0 open | 277 diagnostics · `gabbro paesse` |
...
./instrumente/mutiere-pruefer.py                                 # damage one rule at a time: 391 mutations, one anchor each (`--anker`)
