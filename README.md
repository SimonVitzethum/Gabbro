...
assembly** — **~~74~~ ~~76~~ 78 clean examples, of which ~~53~~ ~~54~~ 78 emit C, and every emitted unit compiles** under `cc -std=c11 -Wall
...
| | | |
|---|---|---|
| **Compiler** | 12 passes, 3 complete, **9 carried with a named residue**, 0 partial, 0 open | ~~289~~ ~~293~~ ~~294~~ ~~295~~ ~~296~~ ~~304~~ ~~311~~ ~~319~~ ~~330~~ 335 diagnostics · `gabbro paesse` |
| **Grammar** | ~~160~~ ~~161~~ ~~163~~ ~~165~~ ~~167~~ **169 EBNF rules**, closed and reachable | vocabulary covers every terminal, ~~220~~ ~~221~~ ~~226~~ (2026-09-12) 228 / 228 |
| **Proof templates** | **21, of which 10 are machine-checked** | Isabelle2025-2, `beweise/` |
| **Pass register** | **~~94~~ ~~124~~ 133 sentences over 12 passes — ~~87~~ ~~116~~ 125 measured, 2 ARGUED, ~~5~~ 6 CONJECTURED, 0 PROVED** (`gabbro paesse --je-satz`, measured 2026-09-12: the row stood at 94 while the register held 121; merge union 124+130−121)**, claiming **~~227~~ ~~268~~ 284 diagnostic codes**. The unmapped remainder is a **ratchet**: it may fall, not rise. *A written statement is not a proved one — the third column is the whole rest* | `gabbro paesse --je-satz` · `./instrumente/pruefe-saetze.py` |
