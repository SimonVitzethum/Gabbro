...
| **Guardians** | 13, each with a two-way speech test | **180 of 180 mutations caught** *(run 2026-08-19)* |
| **Corpus** | 35 clean examples, 172 poison files, 137 tests *(run 2026-08-19)* | `cargo test` |
