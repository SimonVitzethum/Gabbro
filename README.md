...
| | | |
|---|---|---|
| **Compiler** | 12 passes, 3 complete, **9 carried with a named residue**, 0 partial, 0 open | 242 diagnostics · `gabbro paesse` |
...
| **Pass register** | **74 statements over 12 passes — 67 measured, **2 ARGUED**, 5 conjectured, 0 PROVED.** 45 of 242 diagnostics still owe one, and that number is a **ratchet**: it may fall, not rise. *A written statement is not a proved one — the third column is the whole rest* | `gabbro paesse --je-satz` · `./instrumente/pruefe-saetze.py` |
...
| **Corpus** | 57 clean examples, 320 poison files, 241 tests *(run 2026-08-31, locally: `free -g` said 31 GB total, 17 available, 20 cores)* — the last three are `beispiele/55`–`57`, one per quantifier domain that no program had ever written | `cargo test` |
