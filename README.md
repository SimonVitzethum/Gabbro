...
| | | |
|---|---|---|
| **Compiler** | 12 passes, 3 complete, 9 partial, **0 open** | 137 diagnostics · `gabbro paesse` |
...
| **Corpus** | 31 clean examples, 120 poison files, 126 tests *(run 2026-08-19)* | `cargo test` |
