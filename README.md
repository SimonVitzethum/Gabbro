...
| | | |
|---|---|---|
| **Compiler** | 12 passes, 3 complete, 9 partial, **0 open** | 144 diagnostics · `gabbro paesse` |
...
| **Corpus** | 32 clean examples, 135 poison files, 126 tests *(run 2026-08-19)* | `cargo test` |
