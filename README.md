...
| **Corpus** | 57 clean examples, 324 poison files, 241 tests *(run 2026-08-31, locally: `free -g` said 31 GB total, 17 available, 20 cores)* — the last three are `beispiele/55`–`57`, one per quantifier domain that no program had ever written | `cargo test` |
