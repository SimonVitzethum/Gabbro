...
| | | |
|---|---|---|
| **Compiler** | 12 passes, 3 complete, **9 carried with a named residue**, 0 partial, 0 open | 274 diagnostics · `gabbro paesse` |
...
./instrumente/mutiere-pruefer.py                                 # damage one rule at a time: 384 mutations, one anchor each (`--anker`)
