...
assembly** — **71 clean examples, of which 53 emit C, and every emitted unit compiles** under `cc -std=c11 -Wall
...
| | | |
|---|---|---|
| **Compiler** | 12 passes, 3 complete, **9 carried with a named residue**, 0 partial, 0 open | 289 diagnostics · `gabbro paesse` |
| **Grammar** | **160 EBNF rules**, closed and reachable | vocabulary covers every terminal, 220 / 220 |
...
| **Guardians** | 35, and ~~62 of 63~~ **63 of 64 instruments carry all five requirements** — four read statically (deadline · two-way speech test · red on abort · **pinned locale**), the fifth (**work quantity beside the verdict**, W17) measured only by `--lauf`, held by `./instrumente/pruefe-waechter.py` *(run 2026-09-04)* | **387 of 387 anchors hold** *(run 2026-09-03, `mutiere-pruefer.py --anker`)* |
...
./instrumente/mutiere-pruefer.py                                 # damage one rule at a time: 403 mutations, one anchor each (`--anker`)
