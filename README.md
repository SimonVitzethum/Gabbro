...
assembly** — **78 clean examples, of which 54 emit C, and every emitted unit compiles** under `cc -std=c11 -Wall
...
| **Grammar** | ~~160~~ ~~161~~ ~~163~~ ~~167~~ **170 EBNF rules**, closed and reachable | vocabulary covers every terminal, ~~220~~ ~~221~~ ~~226~~ ~~228~~ 233 / 233 |
