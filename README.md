...
| **Guardians** | 13, each with a two-way speech test | **173 of 173 mutations caught** *(run 2026-08-19)* |
| **Corpus** | 34 clean examples, 172 poison files, 138 tests *(run 2026-08-19)* | `cargo test` |
