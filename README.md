...
| | | |
|---|---|---|
| **Compiler** | 12 passes, 3 complete, **9 carried with a named residue**, 0 partial, 0 open | 246 diagnostics · `gabbro paesse` |
...
| **Usability** | **6.1 % of the teaching corpus and 12.8 % of REAL code may fall** — 1050 and 109 clause sites, split derivable / redundant / load-bearing. The calibration travels with the tool (`--tafel`, per rule a may-fall AND a reason), because an uncalibrated usability number makes `effects` and `costs` the cheapest thing to drop | `gabbro zeremonie` · `./instrumente/zaehle-zeremonie.py` |
...
./instrumente/mutiere-pruefer.py                                 # damage one rule at a time: 283 of 283
