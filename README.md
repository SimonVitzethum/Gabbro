...
| | | |
|---|---|---|
| **Compiler** | 10 passes, 3 complete, 7 partial, **0 open** | 134 diagnostics · `gabbro paesse` |
...
| **Corpus** | 31 clean examples, 117 poison files, 126 tests *(run 2026-08-19)* | `cargo test` |
