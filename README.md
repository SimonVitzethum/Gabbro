...
| **Guardians** | 13, each with a two-way speech test | **175 of 175 mutations caught** *(run 2026-08-19)* |
| **Corpus** | 34 clean examples, 172 poison files, 139 tests *(run 2026-08-19)* | `cargo test` |
