...
| | | |
|---|---|---|
| **Compiler** | 12 passes, 3 complete, **9 carried with a named residue**, 0 partial, 0 open | 171 diagnostics · `gabbro paesse` |
| **Grammar** | **142 EBNF rules**, closed and reachable | vocabulary covers every terminal, 211 / 211 |
| **Proof templates** | **21, of which 9 are machine-checked** | Isabelle2025-2, `beweise/` |
| **Guardians** | 13, each with a two-way speech test | **168 of 168 mutations caught** *(run 2026-08-19)* |
| **Corpus** | 34 clean examples, 172 poison files, 131 tests *(run 2026-08-19)* | `cargo test` |
