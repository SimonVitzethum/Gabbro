...
| | | |
|---|---|---|
| **Compiler** | 12 passes, 3 complete, **9 carried with a named residue**, 0 partial, 0 open | 207 diagnostics · `gabbro paesse` |
...
| **Pass register** | **50 statements over 12 passes — 44 measured, 6 conjectured, 0 PROVED.** 45 of 207 diagnostics still owe one, and that number is a **ratchet**: it may fall, not rise. *A written statement is not a proved one — the third column is the whole rest* | `gabbro paesse --je-satz` · `./instrumente/pruefe-saetze.py` |
...
| **Corpus** | 49 clean examples, 247 poison files, 175 tests *(run 2026-08-21)* | `cargo test` |
