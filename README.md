...
assembly** — **70 clean examples, of which 52 emit C, and every emitted unit compiles** under `cc -std=c11 -Wall
...
./instrumente/mutiere-pruefer.py                                 # damage one rule at a time: 397 mutations, one anchor each (`--anker`)
