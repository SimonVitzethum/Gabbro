...
| | | |
|---|---|---|
| **Compiler** | 12 passes, 3 complete, **9 carried with a named residue**, 0 partial, 0 open | 163 diagnostics · `gabbro paesse` |
...
| **Corpus** | 33 clean examples, 163 poison files, 128 tests *(run 2026-08-19)* | `cargo test` |
