...
assembly** — **76 clean examples, of which 54 emit C, and every emitted unit compiles** under `cc -std=c11 -Wall
...
| | | |
|---|---|---|
| **Compiler** | 12 passes, 3 complete, **9 carried with a named residue**, 0 partial, 0 open | ~~289~~ ~~293~~ ~~294~~ ~~295~~ ~~296~~ ~~304~~ ~~330~~ 333 diagnostics · `gabbro paesse` |
