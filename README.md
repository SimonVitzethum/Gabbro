...
assembly** — **74 clean examples, of which 53 emit C, and every emitted unit compiles** under `cc -std=c11 -Wall
...
| | | |
|---|---|---|
| **Compiler** | 12 passes, 3 complete, **9 carried with a named residue**, 0 partial, 0 open | ~~289~~ ~~293~~ ~~294~~ ~~295~~ ~~296~~ ~~304~~ 311 diagnostics · `gabbro paesse` |
| **Grammar** | ~~160~~ ~~161~~ ~~163~~ **165 EBNF rules**, closed and reachable | vocabulary covers every terminal, ~~220~~ ~~221~~ 226 / 226 |
