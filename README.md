...
| **Guardians** | 13, each with a two-way speech test | **167 of 167 mutations caught** *(run 2026-08-19)* |
| **Corpus** | 34 clean examples, 172 poison files, 130 tests *(run 2026-08-19)* | `cargo test` |
...
./mutiere-pruefer.py                                 # damage one rule at a time: 167 of 167
