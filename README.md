...
| **3** | **Funktionale Korrektheit (Gold)** | **Die Decke ist heute: Sicherheitshülle plus deklarierte Invarianten.** Gemessen: die sieben Quantorendomänen fallen **nicht** in eine entscheidbare Theorie, und kein SMT-Löser führt Induktion ([`BEWEISER.md`](BEWEISER.md)). **Aber „programm-spezifische Induktion ist unmöglich" war falsch — sie ist durch drei Entwurfsregeln VERBOTEN**, und ein aus der `table`-Deklaration **erzeugtes** Induktionsschema wäre ein dritter Weg, den niemand betrachtet hatte |
