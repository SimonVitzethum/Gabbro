...
set_option maxHeartbeats 10100000
...
theorem belegen_meets : belegen_meets_statement := by
  ...
  gabbro_pipeline [belegen_body, belegen_pre, belegen_post, wellFormed, hall] using shapeOf
  all_goals (try gabbro_cases 3 []); all_goals (try simp_all)
  trace_state
  all_goals sorry
...
theorem freigeben_if_meets : freigeben_if_meets_statement := by
  ...
  gabbro_pipeline [freigeben_if_body, freigeben_if_pre, freigeben_if_post, wellFormed, griff_weg_pre, griff_weg_requires, griff_weg_post, griff_weg_writes, Frame_read _ _ _ fr_griff_weg, e_i, hall] using shapeOf
  all_goals (try gabbro_cases 3 []); all_goals (try simp_all)
  trace_state
  all_goals sorry
...
theorem freigeben_narrow_meets : freigeben_narrow_meets_statement := by
  ...
  gabbro_pipeline [freigeben_narrow_body, freigeben_narrow_pre, freigeben_narrow_post, wellFormed, griff_weg_pre, griff_weg_requires, griff_weg_post, griff_weg_writes, Frame_read _ _ _ fr_griff_weg, e_i, hall] using shapeOf
  all_goals (try gabbro_cases 3 []); all_goals (try simp_all)
  trace_state
  all_goals sorry
