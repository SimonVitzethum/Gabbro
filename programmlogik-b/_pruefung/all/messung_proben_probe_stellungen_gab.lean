...
/-
  ...
  quantified (5): refused -- a quantifier over a domain other than `slots of`, or a membership
...
/-
  duty_1  W  Knoten :: invariant s1_slots  --  refused (quantified)
  duty_2  W  Knoten :: invariant s2_chain  --  refused (quantified)
  duty_3  W  Knoten :: invariant s3_descendants  --  refused (quantified)
  duty_4  W  Knoten :: invariant s4_ancestors  --  refused (quantified)
  duty_5  W  Knoten :: invariant s8_threads  --  refused (quantified)
...
-- REFUSED  r1_slots  (quantified): a quantifier over a domain other than `slots of`, or a membership
...
-- REFUSED  r2_chain  (quantified): a quantifier over a domain other than `slots of`, or a membership
--   Its contract stands below all the same, so that a caller's theorem can name it;
--   what is missing is the theorem that discharges it.
...
-- REFUSED  r3_descendants  (quantified): a quantifier over a domain other than `slots of`, or a membership
--   Its contract stands below all the same, so that a caller's theorem can name it;
--   what is missing is the theorem that discharges it.
...
-- REFUSED  r4_ancestors  (quantified): a quantifier over a domain other than `slots of`, or a membership
--   Its contract stands below all the same, so that a caller's theorem can name it;
--   what is missing is the theorem that discharges it.
...
-- REFUSED  r6_fields  (quantified): a quantifier over a domain other than `slots of`, or a membership
--   Its contract stands below all the same, so that a caller's theorem can name it;
--   what is missing is the theorem that discharges it.
...
-- REFUSED  r8_threads  (quantified): a quantifier over a domain other than `slots of`, or a membership
--   Its contract stands below all the same, so that a caller's theorem can name it;
--   what is missing is the theorem that discharges it.
...
-- REFUSED  r9_mappings  (quantified): a quantifier over a domain other than `slots of`, or a membership
--   Its contract stands below all the same, so that a caller's theorem can name it;
--   what is missing is the theorem that discharges it.
