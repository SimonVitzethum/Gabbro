/-  Written by `gabbro pflichten --lean`. Do not edit -- the source is the
    ...
    REFUSED by name. The line that has to add up:
        ...
        @duty 1  beispiele/gift/441-ruecksetzung-verlaesst-den-bereich.gab  total 0  goals 0  refused 0
...
namespace GabbroDuty.Duty441RuecksetzungVerlaesstDenBereich
...
def shapeOf : Typing := fun p =>
  ...
  | .slot "Verz" _ "stufe" => some (.intIn 1 9)
  | _ => none
...
end GabbroDuty.Duty441RuecksetzungVerlaesstDenBereich
