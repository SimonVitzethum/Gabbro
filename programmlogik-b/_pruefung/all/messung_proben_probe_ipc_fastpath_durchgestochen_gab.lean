...
/-
  duty_1  E  call :: antwortpflicht_paarig  --  refused (carrier-not-a-table)
-/
...
-- REFUSED  call  (carrier-not-a-table): the carrier of a place is not a declared `table`, record or `format`
