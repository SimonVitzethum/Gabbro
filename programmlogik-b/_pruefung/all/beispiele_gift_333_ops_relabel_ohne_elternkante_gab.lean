/-  Written by `gabbro pflichten --lean`. Do not edit -- the source is the
    ...
    REFUSED by name. The line that has to add up:
        ...
        @duty 1  beispiele/gift/333-ops-relabel-ohne-elternkante.gab  total 0  goals 0  refused 0
...
namespace GabbroDuty.Duty333OpsRelabelOhneElternkante
...
def inv_marke_null_wenn_frei : Expr :=
  (.forallSlots "s" 8 (.bin .or (.place "Verzeichnis" (.name "s") "benutzt") (.bin .eq (.place "Verzeichnis" (.name "s") "marke") (.lit (.int 0)))))
...
end GabbroDuty.Duty333OpsRelabelOhneElternkante
