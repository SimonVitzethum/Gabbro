...
def summe_1071_body : List Stmt :=
  [(.bindName "s" (.lit (.int 0))), (.bindName "#pass" (.lit (.int 0))), (.loop "summe_1071#1" (.bin .and (.hasShape "s" (.intIn 0 4294967295)) (.bin .and (.hasShape "#pass" .int) (.bin .le (.name "s") (.bin .mul (.lit (.int 65535)) (.name "#pass"))))) [(.bindName "#pass" (.bin .add (.name "#pass") (.lit (.int 1)))), (.bindName "s" (.bin .add (.name "s") (.place "Kopfworte.wort" (.name "i") "elem")))]), (.ret (some (.name "s")))]
...
def summe_1071_loop_1_inv : Expr :=
  (.bin .and (.hasShape "s" (.intIn 0 4294967295)) (.bin .and (.hasShape "#pass" .int) (.bin .le (.name "s") (.bin .mul (.lit (.int 65535)) (.name "#pass")))))

def summe_1071_loop_1_body : List Stmt :=
  [(.bindName "#pass" (.bin .add (.name "#pass") (.lit (.int 1)))), (.bindName "s" (.bin .add (.name "s") (.place "Kopfworte.wort" (.name "i") "elem")))]
...
theorem summe_1071_loop_1_keeps : summe_1071_loop_1_keeps_statement := by
  ...
  have hall := hinv
  gabbro_simp_at hall [summe_1071_loop_1_inv, e_s, e__pass, h_Kopfworte.wort_elem_i]
  gabbro_auto [summe_1071_loop_1_body, summe_1071_loop_1_inv, wellFormed, e_s, e__pass, h_Kopfworte.wort_elem_i, hall, hpass] using shapeOf
...
def summe_1071_meets_statement : Prop :=
  ∀ (ρ : Env) (s : State)
    ...
    (l_summe_1071_loop_1 : LoopRuleP ρ "summe_1071#1" wellFormed summe_1071_loop_1_inv "#pass"),
...
def Program (ρ : Env) : Prop :=
  ...
  ∧ RunsLoopN ρ "summe_1071#1" summe_1071_loop_1_body "i" 0 65536 10
...
theorem unit_closed (ρ : Env) (hp : Program ρ) (ha : Assumed ρ)
    ...
    ∧ LoopRuleP ρ "summe_1071#1" wellFormed summe_1071_loop_1_inv "#pass"
  ...
  have l_summe_1071_loop_1 : LoopRuleP ρ "summe_1071#1" wellFormed summe_1071_loop_1_inv "#pass" :=
    looprule_of_body_p ρ "summe_1071#1" wellFormed summe_1071_loop_1_inv summe_1071_loop_1_body "i" "#pass" 0 65536 10 rl_summe_1071_loop_1
      (fun t k i hlo hhi hplo hphi hpass hw hin => d_summe_1071_loop_1 ρ t k i hlo hhi hplo hphi hpass hw hin)
