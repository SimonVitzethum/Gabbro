...
def close_pre : Expr :=
  (.hasShape "a" (.intIn (-2147483648) 2147483647))
...
def nimm_wache_pre : Expr :=
  (.bin .and (.hasShape "a" (.intIn 0 18446744073709551615)) (.hasShape "w" (.intIn 0 18446744073709551615)))
...
def plattenschritt_pre : Expr :=
  (.hasShape "fd" (.intIn 0 18446744073709551615))
...
def shutdown_pre : Expr :=
  (.bin .and (.hasShape "a" (.intIn (-2147483648) 2147483647)) (.hasShape "b" (.intIn (-2147483648) 2147483647)))
...
def haupt_body : List Stmt :=
  [(.bindCall "a" "plattenschritt" ["fd"] [(.name "fd")] (.hasShape "fd" (.intIn 0 18446744073709551615))), (.call "nimm_wache" ["a", "w"] [(.name "fd"), (.name "a")] (.bin .and (.hasShape "a" (.intIn 0 18446744073709551615)) (.hasShape "w" (.intIn 0 18446744073709551615)))), (.bindCall "s" "close" ["a"] [(.lit (.int 1))] (.hasShape "a" (.intIn (-2147483648) 2147483647))), (.bindCall "r" "raise" ["a"] [(.lit (.int 2))] (.hasShape "a" (.intIn (-2147483648) 2147483647))), (.bindCall "t" "shutdown" ["a", "b"] [(.lit (.int 3)), (.lit (.int 0))] (.bin .and (.hasShape "a" (.intIn (-2147483648) 2147483647)) (.hasShape "b" (.intIn (-2147483648) 2147483647)))), (.bindCall "p" "pthread_self" [] [] (.lit (.bool true))), (.retCall "mmap" ["a"] [(.name "a")] (.hasShape "a" (.intIn 0 18446744073709551615)))]
...
theorem unit_closed (ρ : Env) (hp : Program ρ) (ha : Assumed ρ)
  ...
  obtain ⟨c_close, fr_close, c_mmap, fr_mmap, c_nimm_wache, fr_nimm_wache, c_plattenschritt, fr_plattenschritt, c_pthread_self, fr_pthread_self, c_raise, fr_raise, c_shutdown, fr_shutdown⟩ := ha
  have c_haupt : Contract ρ "haupt" haupt_requires haupt_post :=
    contract_of_duty ρ "haupt" haupt_body haupt_requires haupt_post r_haupt
      (fun t ht => d_haupt ρ t ht.1 ht.2 c_close fr_close c_mmap fr_mmap c_nimm_wache fr_nimm_wache c_plattenschritt fr_plattenschritt c_pthread_self fr_pthread_self c_raise fr_raise c_shutdown fr_shutdown)
  exact c_haupt

end GabbroDuty.DutyProbeCNamenFrei
