...
/-
  ...
  builtin (1): refused -- a built-in about the LAYOUT, and this model has none
...
/-
  duty_1  N  folge_lesen :: ensures #1  --  refused (builtin)
-/
...
-- REFUSED  folge_lesen  (builtin): a built-in about the LAYOUT, and this model has none
