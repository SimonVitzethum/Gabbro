/-  Written by `gabbro pflichten --lean`. Do not edit -- the source is the
    ...
    REFUSED by name. The line that has to add up:
        ...
        @duty 1  messung/proben/probe-eintritt-parameter.gab  total 0  goals 0  refused 0
...
namespace GabbroDuty.DutyProbeEintrittParameter
...
theorem main_meets : main_meets_statement := by
  ...
  have hall := hpre
  gabbro_simp_at hall [main_pre, e_z]
  gabbro_auto [main_body, main_pre, main_post, wellFormed, e_z, hall] using shapeOf
...
end GabbroDuty.DutyProbeEintrittParameter
