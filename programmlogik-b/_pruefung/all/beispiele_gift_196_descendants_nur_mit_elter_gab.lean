/-  Written by `gabbro pflichten --lean`. Do not edit -- the source is the
    ...
    REFUSED by name. The line that has to add up:
        ...
        @duty 1  beispiele/gift/196-descendants-nur-mit-elter.gab  total 0  goals 0  refused 0
...
namespace GabbroDuty.Duty196DescendantsNurMitElter
...
def Program (ρ : Env) : Prop :=
  ...
  ∧ RunsLoopIn ρ "raeume#1" raeume_loop_1_body "v" 0 8
...
theorem unit_closed (ρ : Env) (hp : Program ρ) (ha : Assumed ρ)
  ...
  have l_raeume_loop_1 : LoopRule ρ "raeume#1" wellFormed raeume_loop_1_inv :=
    looprule_of_body_in ρ "raeume#1" wellFormed raeume_loop_1_inv raeume_loop_1_body "v" 0 8 rl_raeume_loop_1
      (fun t k hlo hhi hw hi => d_raeume_loop_1 ρ t k hlo hhi hw hi)
...
end GabbroDuty.Duty196DescendantsNurMitElter
