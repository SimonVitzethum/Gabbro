...
theorem absteigen_meets : absteigen_meets_statement := by
  ...
  gabbro_auto? [absteigen_body, absteigen_pre, absteigen_post, wellFormed, absteigen_pre, absteigen_requires, absteigen_post, absteigen_writes, Frame_read _ _ _ fr_absteigen, absteigen_decreases, e_n] using shapeOf
