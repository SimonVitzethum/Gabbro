...
theorem einreihen_meets : einreihen_meets_statement := by
  ...
  gabbro_try 300 (gabbro_simp [einreihen_body, einreihen_pre, einreihen_post, wellFormed, einreihen_inv_wartende_haben_grund, e_e, e_t, hall])
  gabbro_try 300 (all_goals (try gabbro_cases 4 [einreihen_body, einreihen_pre, einreihen_post, wellFormed, einreihen_inv_wartende_haben_grund, e_e, e_t, hall]))
  gabbro_try 300 (all_goals (try gabbro_calls shapeOf [einreihen_body, einreihen_pre, einreihen_post, wellFormed, einreihen_inv_wartende_haben_grund, e_e, e_t, hall]))
  gabbro_try 300 (all_goals (try gabbro_simp_hyps [einreihen_body, einreihen_pre, einreihen_post, wellFormed, einreihen_inv_wartende_haben_grund, e_e, e_t, hall]))
  gabbro_try 300 (all_goals (try gabbro_forall [einreihen_body, einreihen_pre, einreihen_post, wellFormed, einreihen_inv_wartende_haben_grund, e_e, e_t, hall]))
  gabbro_try 300 (all_goals (try gabbro_simp_hyps [einreihen_body, einreihen_pre, einreihen_post, wellFormed, einreihen_inv_wartende_haben_grund, e_e, e_t, hall]))
  gabbro_try 200 (all_goals (try gabbro_cases 3 [einreihen_body, einreihen_pre, einreihen_post, wellFormed, einreihen_inv_wartende_haben_grund, e_e, e_t, hall]))
  gabbro_try 200 (all_goals (try gabbro_simp_hyps [einreihen_body, einreihen_pre, einreihen_post, wellFormed, einreihen_inv_wartende_haben_grund, e_e, e_t, hall]))
  gabbro_try 50 (all_goals (try (repeat' apply And.intro)))
  gabbro_try 50 (all_goals (try intros))
  gabbro_try 100 (all_goals (try gabbro_wf shapeOf))
  gabbro_try 50 (all_goals (try gabbro_shape shapeOf))
  gabbro_try 200 (all_goals (try gabbro_simp_hyps [einreihen_body, einreihen_pre, einreihen_post, wellFormed, einreihen_inv_wartende_haben_grund, e_e, e_t, hall]))
  gabbro_try 200 (all_goals (try gabbro_cases 3 [einreihen_body, einreihen_pre, einreihen_post, wellFormed, einreihen_inv_wartende_haben_grund, e_e, e_t, hall]))
  gabbro_try 200 (all_goals (try gabbro_forall [einreihen_body, einreihen_pre, einreihen_post, wellFormed, einreihen_inv_wartende_haben_grund, e_e, e_t, hall]))
  gabbro_try 200 (all_goals (try gabbro_simp_hyps [einreihen_body, einreihen_pre, einreihen_post, wellFormed, einreihen_inv_wartende_haben_grund, e_e, e_t, hall]))
  gabbro_try 50 (all_goals (try (repeat' apply And.intro)))
  gabbro_try 50 (all_goals (try intros))
  gabbro_try 100 (all_goals (try gabbro_wf shapeOf))
  gabbro_try 50 (all_goals (try gabbro_shape shapeOf))
  gabbro_try 200 (all_goals (try (simp [einreihen_body, einreihen_pre, einreihen_post, wellFormed, einreihen_inv_wartende_haben_grund, e_e, e_t, hall, *]; done)))
  gabbro_try 300 (all_goals (try (gabbro_split <;> (try intros) <;> (try (simp [einreihen_body, einreihen_pre, einreihen_post, wellFormed, einreihen_inv_wartende_haben_grund, e_e, e_t, hall, *]; done)))))
  trace_state
