/-  Written by `gabbro pflichten --lean`. Do not edit -- the source is the
    ...
    REFUSED by name. The line that has to add up:
        ...
        @duty 1  beispiele/gift/658-an-update-body-that-falls-through.gab  total 0  goals 0  refused 0
...
namespace GabbroDuty.Duty658AnUpdateBodyThatFallsThrough
...
def shapeOf : Typing := fun p =>
  match p with
  | .global "ZAEHLER" => some (.intIn 0 1000)
  | _ => none
...
end GabbroDuty.Duty658AnUpdateBodyThatFallsThrough