/-  Written by `gabbro pflichten --lean`. Do not edit -- the source is the
    ...
    REFUSED by name. The line that has to add up:
        ...
        @duty 1  beispiele/gift/605-an-array-field-takes-only-zero.gab  total 0  goals 0  refused 0
...
namespace GabbroDuty.Duty605AnArrayFieldTakesOnlyZero
...
def shapeOf : Typing := fun p =>
  match p with
  | .slot "ANDERS" _ "elem" => some (.intIn 0 255)
  | .slot "Text.bytes" _ "elem" => some (.intIn 0 255)
  | .field "Text" "len" => some (.intIn 0 8)
  | _ => none
...
end GabbroDuty.Duty605AnArrayFieldTakesOnlyZero