/-  Written by `gabbro pflichten --lean`. Do not edit -- the source is the
    ...
    REFUSED by name. The line that has to add up:
        ...
        @duty 1  beispiele/gift/657-a-port-number-past-the-port-space.gab  total 0  goals 0  refused 0
...
namespace GabbroDuty.Duty657APortNumberPastThePortSpace
...
-- REFUSED  lies  (record-value): a field of a record VALUE bound in the body (`let c = f(x); c.len`) -- this model's places are named by a record TYPE; pass the record through a `ptr` parameter
...
end GabbroDuty.Duty657APortNumberPastThePortSpace