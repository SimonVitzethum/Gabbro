...
theorem f_meets : f_meets_statement := by
  ...
  gabbro_auto [f_body, f_pre, f_post, wellFormed, abbruch_pre, abbruch_requires, abbruch_post, abbruch_writes, Frame_read _ _ _ fr_abbruch, hol_pre, hol_requires, hol_post, hol_writes, Frame_read _ _ _ fr_hol, hall] using shapeOf
