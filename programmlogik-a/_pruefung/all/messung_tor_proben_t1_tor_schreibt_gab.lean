/-  Written by `gabbro pflichten --lean`. Do not edit -- the source is the
    ...
    REFUSED by name. The line that has to add up:
        ...
        @duty 1  messung/tor-proben/t1-tor-schreibt.gab  total 0  goals 0  refused 0
...
namespace GabbroDuty.DutyT1TorSchreibt
...
def tor_body : List Stmt :=
  [(.assignGlobal "k" (.lit (.int 1))), (.ret none)]

/-- The precondition: the declared shapes and the `requires`. -/
def tor_pre : Expr :=
  (.lit (.bool true))

def tor_writes : List String := ["k"]
...
theorem tor_meets : tor_meets_statement := by
  ...
  have hall := hpre
  gabbro_simp_at hall [tor_pre]
  gabbro_auto [tor_body, tor_pre, tor_post, wellFormed, hall] using shapeOf
...
end GabbroDuty.DutyT1TorSchreibt