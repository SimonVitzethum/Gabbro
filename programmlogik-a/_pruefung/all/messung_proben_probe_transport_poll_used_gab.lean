/-  Written by `gabbro pflichten --lean`. Do not edit -- the source is the
    ...
    REFUSED by name. The line that has to add up:
        ...
        @duty 1  messung/proben/probe-transport-poll-used.gab  total 0  goals 0  refused 0
...
namespace GabbroDuty.DutyProbeTransportPollUsed
...
def shapeOf : Typing := fun p =>
  ...
  | .field "Abschluss" "kopf" => some (.intIn 0 4294967295)
  | .field "Abschluss" "laenge" => some (.intIn 0 4294967295)
  | .global "usedring_gesehen" => some (.intIn 0 4294967295)
...
-- REFUSED  poll_used  (constructed-value): a record, a `tagged` or a device handle -- this model has no value for one
...
def poll_used_pre : Expr :=
  (.bin .and (.hasShape "i" (.intIn 0 7)) (.hasShape "von" (.intIn 0 65535)))
...
end GabbroDuty.DutyProbeTransportPollUsed