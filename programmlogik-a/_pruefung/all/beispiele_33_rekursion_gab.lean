...
def shapeOf : Typing := fun p =>
  ...
  | .slot "Knoten" _ "tiefe" => some (.intIn 0 512)
  | .global "summe" => some (.intIn 0 4294967295)
  | _ => none
...
def absteigen_body : List Stmt :=
  [(.assignGlobal "summe" (.name "n")), (.ite (.bin .eq (.name "n") (.lit (.int 0))) [(.ret (some (.lit (.int 0))))] []), (.retCall "absteigen" ["n"] [(.bin .sub (.name "n") (.lit (.int 1)))] (.hasShape "n" (.intIn 0 512)))]

/-- The precondition: the declared shapes and the `requires`. -/
def absteigen_pre : Expr :=
  (.hasShape "n" (.intIn 0 512))
...
def gerade_body : List Stmt :=
  [(.assignGlobal "summe" (.name "n")), (.ite (.bin .ge (.name "n") (.lit (.int 1))) [(.retCall "ungerade" ["n"] [(.bin .sub (.name "n") (.lit (.int 1)))] (.hasShape "n" (.intIn 0 512)))] []), (.ret (some (.lit (.int 0))))]
...
def ungerade_body : List Stmt :=
  [(.assignGlobal "summe" (.name "n")), (.ite (.bin .ge (.name "n") (.lit (.int 1))) [(.retCall "gerade" ["n"] [(.bin .sub (.name "n") (.lit (.int 1)))] (.hasShape "n" (.intIn 0 512)))] []), (.ret (some (.lit (.int 0))))]
