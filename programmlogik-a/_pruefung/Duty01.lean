...
def Initially (s0 : State) : Prop :=
  ...
  ∧ eval s0 inv_baum_bleibt_baum = some (.bool true)
...
def aushaengen_pre : Expr :=
  (.bin .and (.bin .and (.hasShape "s" .int) (.bin .and (.bin .le (.lit (.int 0)) (.name "s")) (.bin .le (.name "s") (.lit (.int 4095))))) (.bin .and (.lit (.bool true)) (.bin .and (.place "Kappenraum" (.name "s") "benutzt") (.bin .and (.forallSlots "s" 4096 (.reaches "Kappenraum" (.name "s") (.lit (.int 0)) "elter" 4096)) (.bin .and (.forallSlots "s" 4096 (.bin .or (.un .not (.bin .eq (.place "Kappenraum" (.name "s") "elter") (.lit .absent))) (.bin .eq (.place "Kappenraum" (.name "s") "vorheriges") (.lit .absent)))) (.forallSlots "s" 4096 (.reaches "Kappenraum" (.name "s") (.lit (.int 0)) "elter" 4096)))))))
...
def blatt_loeschen_body : List Stmt :=
  [(.bindName "obj" (.place "Kappenraum" (.name "s") "objekt")), (.call "aushaengen" ["c", "s"] [(.name "c"), (.name "s")] (.bin .and (.bin .and (.hasShape "s" .int) (.bin .and (.bin .le (.lit (.int 0)) (.name "s")) (.bin .le (.name "s") (.lit (.int 4095))))) (.bin .and (.lit (.bool true)) (.bin .and (.place "Kappenraum" (.name "s") "benutzt") (.bin .and (.forallSlots "s" 4096 (.reaches "Kappenraum" (.name "s") (.lit (.int 0)) "elter" 4096)) (.bin .and (.forallSlots "s" 4096 (.bin .or (.un .not (.bin .eq (.place "Kappenraum" (.name "s") "elter") (.lit .absent))) (.bin .eq (.place "Kappenraum" (.name "s") "vorheriges") (.lit .absent)))) (.forallSlots "s" 4096 (.reaches "Kappenraum" (.name "s") (.lit (.int 0)) "elter" 4096)))))))), (.assign "Kappenraum" (.name "s") "marke" (.wrapTo 32 false (.bin .add (.place "Kappenraum" (.name "s") "marke") (.lit (.int 1))))), (.assign "Kappenraum" (.name "s") "benutzt" (.lit (.bool false))), (.ite (.bin .ge (.place "Objekte" (.name "obj") "zaehler") (.lit (.int 1))) [(.assign "Objekte" (.name "obj") "zaehler" (.bin .sub (.place "Objekte" (.name "obj") "zaehler") (.lit (.int 1))))] []), (.ite (.bin .eq (.place "Objekte" (.name "obj") "zaehler") (.lit (.int 0))) [(.onTag (.place "Objekte" (.name "obj") "art") [("Speicher", some "p", [(.call "speicher_freigeben" ["p"] [(.name "p")] (.lit (.bool true)))]), ("Endpunkt", some "e", []), ("Faden", some "f", []), ("Antwort", some "a", [])]), (.assign "Objekte" (.name "obj") "benutzt" (.lit (.bool false)))] [])]

/-- The precondition: the declared shapes and the `requires`. -/
def blatt_loeschen_pre : Expr :=
  (.bin .and (.bin .and (.hasShape "s" .int) (.bin .and (.bin .le (.lit (.int 0)) (.name "s")) (.bin .le (.name "s") (.lit (.int 4095))))) (.bin .and (.lit (.bool true)) (.bin .and (.place "Kappenraum" (.name "s") "benutzt") (.bin .and (.bin .and (.place "Kappenraum" (.name "s") "benutzt") (.bin .eq (.place "Kappenraum" (.name "s") "erstes_kind") (.lit .absent))) (.bin .and (.forallSlots "s" 4096 (.reaches "Kappenraum" (.name "s") (.lit (.int 0)) "elter" 4096)) (.bin .and (.forallSlots "s" 4096 (.bin .or (.un .not (.bin .eq (.place "Kappenraum" (.name "s") "elter") (.lit .absent))) (.bin .eq (.place "Kappenraum" (.name "s") "vorheriges") (.lit .absent)))) (.forallSlots "s" 4096 (.reaches "Kappenraum" (.name "s") (.lit (.int 0)) "elter" 4096))))))))
...
def einsammeln_body : List Stmt :=
  [(.loop "einsammeln#1" (.bin .and (.bin .and (.hasShape "s" .int) (.bin .and (.bin .le (.lit (.int 0)) (.name "s")) (.bin .le (.name "s") (.lit (.int 4095))))) (.bin .and (.forallSlots "s" 4096 (.reaches "Kappenraum" (.name "s") (.lit (.int 0)) "elter" 4096)) (.bin .and (.forallSlots "s" 4096 (.bin .or (.un .not (.bin .eq (.place "Kappenraum" (.name "s") "elter") (.lit .absent))) (.bin .eq (.place "Kappenraum" (.name "s") "vorheriges") (.lit .absent)))) (.bin .and (.forallSlots "s" 4096 (.reaches "Kappenraum" (.name "s") (.lit (.int 0)) "elter" 4096)) (.place "Kappenraum" (.name "s") "benutzt"))))) [(.call "blatt_loeschen" ["c", "o", "s"] [(.name "c"), (.name "o"), (.name "opfer")] (.bin .and (.bin .and (.hasShape "s" .int) (.bin .and (.bin .le (.lit (.int 0)) (.name "s")) (.bin .le (.name "s") (.lit (.int 4095))))) (.bin .and (.lit (.bool true)) (.bin .and (.place "Kappenraum" (.name "s") "benutzt") (.bin .and (.bin .and (.place "Kappenraum" (.name "s") "benutzt") (.bin .eq (.place "Kappenraum" (.name "s") "erstes_kind") (.lit .absent))) (.bin .and (.forallSlots "s" 4096 (.reaches "Kappenraum" (.name "s") (.lit (.int 0)) "elter" 4096)) (.bin .and (.forallSlots "s" 4096 (.bin .or (.un .not (.bin .eq (.place "Kappenraum" (.name "s") "elter") (.lit .absent))) (.bin .eq (.place "Kappenraum" (.name "s") "vorheriges") (.lit .absent)))) (.forallSlots "s" 4096 (.reaches "Kappenraum" (.name "s") (.lit (.int 0)) "elter" 4096)))))))))])]

/-- The precondition: the declared shapes and the `requires`. -/
def einsammeln_pre : Expr :=
  (.bin .and (.bin .and (.hasShape "s" .int) (.bin .and (.bin .le (.lit (.int 0)) (.name "s")) (.bin .le (.name "s") (.lit (.int 4095))))) (.bin .and (.lit (.bool true)) (.bin .and (.forallSlots "s" 4096 (.reaches "Kappenraum" (.name "s") (.lit (.int 0)) "elter" 4096)) (.bin .and (.forallSlots "s" 4096 (.reaches "Kappenraum" (.name "s") (.lit (.int 0)) "elter" 4096)) (.bin .and (.forallSlots "s" 4096 (.bin .or (.un .not (.bin .eq (.place "Kappenraum" (.name "s") "elter") (.lit .absent))) (.bin .eq (.place "Kappenraum" (.name "s") "vorheriges") (.lit .absent)))) (.forallSlots "s" 4096 (.reaches "Kappenraum" (.name "s") (.lit (.int 0)) "elter" 4096)))))))
...
theorem aushaengen_meets : aushaengen_meets_statement := by
  ...
  have hi_baum_wohlgeformt := (and_left _ _ _ (and_right _ _ _ (and_right _ _ _ (and_right _ _ _ hpre))))
  gabbro_simp_at hi_baum_wohlgeformt [aushaengen_inv_baum_wohlgeformt]
  have hi_wurzel_ohne_vorgaenger := (and_left _ _ _ (and_right _ _ _ (and_right _ _ _ (and_right _ _ _ (and_right _ _ _ hpre)))))
  gabbro_simp_at hi_wurzel_ohne_vorgaenger [aushaengen_inv_wurzel_ohne_vorgaenger]
  have hi_baum_bleibt_baum := (and_right _ _ _ (and_right _ _ _ (and_right _ _ _ (and_right _ _ _ (and_right _ _ _ hpre)))))
  gabbro_simp_at hi_baum_bleibt_baum [aushaengen_inv_baum_bleibt_baum]
  obtain ⟨w_s, e_s, lo_s, hi_s⟩ := shape_int_in s "s" _ _ (and_left _ _ _ hpre)
  rcases WF_opt shapeOf s.world (.slot "Kappenraum" w_s "vorheriges") hwf rfl with h_Kappenraum_vorheriges_s | ⟨n_Kappenraum_vorheriges_s, h_Kappenraum_vorheriges_s⟩ <;>
    ...
    <;> gabbro_auto [aushaengen_body, aushaengen_pre, aushaengen_post, wellFormed, aushaengen_inv_baum_wohlgeformt, aushaengen_inv_wurzel_ohne_vorgaenger, aushaengen_inv_baum_bleibt_baum, e_s, h_Kappenraum_vorheriges_s, h_Kappenraum_naechstes_s, h_Kappenraum_elter_s] using shapeOf
...
theorem blatt_loeschen_meets : blatt_loeschen_meets_statement := by
  ...
  gabbro_simp_at hi_baum_wohlgeformt [blatt_loeschen_inv_baum_wohlgeformt]
  have hi_wurzel_ohne_vorgaenger := (and_left _ _ _ (and_right _ _ _ (and_right _ _ _ (and_right _ _ _ (and_right _ _ _ (and_right _ _ _ hpre))))))
  gabbro_simp_at hi_wurzel_ohne_vorgaenger [blatt_loeschen_inv_wurzel_ohne_vorgaenger]
  have hi_baum_bleibt_baum := (and_right _ _ _ (and_right _ _ _ (and_right _ _ _ (and_right _ _ _ (and_right _ _ _ (and_right _ _ _ hpre))))))
  gabbro_simp_at hi_baum_bleibt_baum [blatt_loeschen_inv_baum_bleibt_baum]
  obtain ⟨w_s, e_s, lo_s, hi_s⟩ := shape_int_in s "s" _ _ (and_left _ _ _ hpre)
...
def einsammeln_loop_1_inv : Expr :=
  (.bin .and (.bin .and (.hasShape "s" .int) (.bin .and (.bin .le (.lit (.int 0)) (.name "s")) (.bin .le (.name "s") (.lit (.int 4095))))) (.bin .and (.forallSlots "s" 4096 (.reaches "Kappenraum" (.name "s") (.lit (.int 0)) "elter" 4096)) (.bin .and (.forallSlots "s" 4096 (.bin .or (.un .not (.bin .eq (.place "Kappenraum" (.name "s") "elter") (.lit .absent))) (.bin .eq (.place "Kappenraum" (.name "s") "vorheriges") (.lit .absent)))) (.bin .and (.forallSlots "s" 4096 (.reaches "Kappenraum" (.name "s") (.lit (.int 0)) "elter" 4096)) (.place "Kappenraum" (.name "s") "benutzt")))))
...
theorem einsammeln_loop_1_keeps : einsammeln_loop_1_keeps_statement := by
  ...
  gabbro_simp_at hi_baum_wohlgeformt [einsammeln_inv_baum_wohlgeformt]
  have hi_wurzel_ohne_vorgaenger := (and_left _ _ _ (and_right _ _ _ (and_right _ _ _ hinv)))
  gabbro_simp_at hi_wurzel_ohne_vorgaenger [einsammeln_inv_wurzel_ohne_vorgaenger]
  have hi_baum_bleibt_baum := (and_left _ _ _ (and_right _ _ _ (and_right _ _ _ (and_right _ _ _ hinv))))
  gabbro_simp_at hi_baum_bleibt_baum [einsammeln_inv_baum_bleibt_baum]
  obtain ⟨w_s, e_s, lo_s, hi_s⟩ := shape_int_in t "s" _ _ (and_left _ _ _ hinv)
  gabbro_auto [einsammeln_loop_1_body, einsammeln_loop_1_inv, wellFormed, blatt_loeschen_pre, blatt_loeschen_requires, blatt_loeschen_post, blatt_loeschen_writes, Frame_read _ _ _ fr_blatt_loeschen, e_s] using shapeOf
...
theorem einsammeln_meets : einsammeln_meets_statement := by
  ...
  obtain ⟨w_s, e_s, lo_s, hi_s⟩ := shape_int_in s "s" _ _ (and_left _ _ _ hpre)
  obtain ⟨n_Kappenraum_benutzt_s, h_Kappenraum_benutzt_s⟩ := WF_bool shapeOf s.world (.slot "Kappenraum" w_s "benutzt") hwf rfl
  gabbro_auto [einsammeln_body, einsammeln_pre, einsammeln_post, wellFormed, einsammeln_inv_baum_wohlgeformt, einsammeln_inv_wurzel_ohne_vorgaenger, einsammeln_inv_baum_bleibt_baum, blatt_loeschen_pre, blatt_loeschen_requires, blatt_loeschen_post, blatt_loeschen_writes, Frame_read _ _ _ fr_blatt_loeschen, einsammeln_loop_1_inv, e_s, h_Kappenraum_benutzt_s] using shapeOf
